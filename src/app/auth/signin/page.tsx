    ...
    <div className="min-h-screen bg-emerald-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg">
        <div className="text-center">
          <h2 className="mt-6 text-3xl font-bold text-emerald-800">Welcome to Creators Meet</h2>
          <p className="mt-2 text-sm text-gray-600">Join our community of creators and start earning points!</p>
        </div>
