    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-purple-950/20 to-black flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          <div className="relative glass-effect bg-black/80 backdrop-blur-2xl p-8 md:p-10 rounded-3xl shadow-2xl border border-white/20">
            {/* Logo and Title */}
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-2 gap-4">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  type="button"
                  className="flex items-center justify-center gap-3 px-4 py-3 bg-black/40 border border-white/10 hover:border-white/20 rounded-lg hover:bg-black/60 transition-all text-white"
                >
