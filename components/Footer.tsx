        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://github.com" className="text-gray-400 hover:text-primary-400 hover:glow-text transition-all duration-300">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a href="https://linkedin.com" className="text-gray-400 hover:text-primary-400 hover:glow-text transition-all duration-300">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <form className="mt-4">
              ...
              <div className="flex">
                <input
                  ...
                  className="px-4 py-2 w-full bg-dark-700 border border-dark-600 text-white rounded-l focus:outline-none focus:ring-1 focus:ring-primary-500"
                />
                <button
                  type="submit"
