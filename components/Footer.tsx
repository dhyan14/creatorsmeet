    ...
    <footer className="bg-primary-800 text-white pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">CreatorsMeet</h3>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://github.com" className="text-white hover:text-primary-300">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/developers" className="text-primary-100 hover:text-white transition-colors">
                  Developers
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-primary-100 mb-2">Email: info@creatorsmeet.com</p>
            <p className="text-primary-100 mb-4">Phone: +1 (555) 123-4567</p>
            <form className="mt-4">
              ...
              <div className="flex">
                ...
                <button
                  type="submit"
                  className="bg-primary-500 px-4 py-2 rounded-r hover:bg-primary-400 transition-colors"
                >
                  Subscribe
                </button>
              </div>
